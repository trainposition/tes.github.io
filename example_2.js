$(function () {
    ...
    var basemapLayer = new L.TileLayer('https://api.mapbox.com/styles/v1/mapbox/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1Ijoid2FoeXVkbSIsImEiOiJjazliYzh2YmcwMnduM2hueWV3a3ozbW5sIn0.VXnWR-rP0rVVR5Z8tqCBqA', {
        maxZoom: 20,
        attribution: '',
        id: 'dark-v9',
        tileSize: 512,
